...
namespace EventAgency.Data.Migrations
{
    ...
    [Migration("20250731133432_AddOrderAndOrderItemModelsAndTheirConfigurations")]
    partial class AddOrderAndOrderItemModelsAndTheirConfigurations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventAgency.Data.Models.ApplicationUserProduct", b =>
                {
                    ...
                    b.ToTable("ApplicationUserProducts", t =>
                        {
                            t.HasComment("User Cart entry in the system.");
                        });
                });
            ...
            modelBuilder.Entity("EventAgency.Data.Models.EventReservationRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EventReservationRequests");
                });

            modelBuilder.Entity("EventAgency.Data.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("Address")
                        ...
                        .HasComment("Delivery address associated with the order");
                    ...
                    b.Property<bool>("IsCancelled")
                        ...
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasComment("Indicates whether the order is cancelled by the admin");

                    b.Property<bool>("IsConfirmed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasComment("Indicates whether the order is confirmed by the admin");

                    b.Property<string>("PaymentMethod")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Payment method chosen for the order (e.g., 'Cash on Delivery')");

                    b.Property<string>("Phone")
                        .IsRequired()
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)")
                        .HasComment("Phone number for contact regarding the order");
                    ...
                    b.ToTable("Orders", t =>
                        {
                            t.HasComment("Order in the system");
                        });
                });

            modelBuilder.Entity("EventAgency.Data.Models.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("OrderId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Foreign key for the associated order");

                    b.Property<decimal>("Price")
                        .HasColumnType("decimal(18, 2)")
                        .HasComment("Unit price of the product");

                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("The product in the order");

                    b.Property<string>("ProductName")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("Product name in the order");
                    ...
                    b.Property<decimal>("TotalPrice")
                        .HasColumnType("decimal(18, 2)")
                        .HasComment("Total price for this item (Price * Quantity)");
            ...
            modelBuilder.Entity("EventAgency.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("26c24284-94b5-4923-8dfb-d07519cf4d35"),
                            CategoryId = 9,
                        ...
                        new
                        {
                            Id = new Guid("50670638-d177-40c4-a699-ba8193fd6c4a"),
                            CategoryId = 9,
                            Description = "Балоните са подходящи за украса за Рожден ден ,Юбилей ,Кръщене , Сватба ,Абитуриентски бал и др .Балоните са произведени от натурален латекс и са 100 % биологически разградими!",
            ...
            modelBuilder.Entity("EventAgency.Data.Models.ApplicationUserProduct", b =>
                {
                    ...
                    b.HasOne("EventAgency.Data.Models.Product", "Product")
                        .WithMany("UserCart")
            ...
            modelBuilder.Entity("EventAgency.Data.Models.OrderItem", b =>
                {
                    b.HasOne("EventAgency.Data.Models.Order", "Order")
                        .WithMany("OrderItems")
